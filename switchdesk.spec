...
Source: http://than.fedorapeople.org/%{name}/%{name}-%{version}.tar.gz
License: GPLv2+
BuildArch: noarch
BuildRequires: make
...
%changelog
* Fri Oct 21 2022 Than Ngo <than@redhat.com> - 5.0.2-1
- 5.0.2 release

* Thu Sep 29 2022 Than Ngo <than@redhat.com> - 5.0.1-12
- fixed bz#2130080, switchdesk crash

* Mon Jul 25 2022 Than Ngo <than@redhat.com> - 5.0.1-11
